...
<html>
    ...
    <body>
        ...
        <section>
            <article>
                <h1>Nos partenaires</h1></caption>
                <img src="https://www.pole-emploi.fr/files/live/sites/PE/files/nouveau%20site/candidat/service-en-ligne/Emploi-store-logo-308.gif"alt="image article"/>
                <img src="https://www.adrar-formation.com/sites/all/themes/adrar/logo.png"alt="image article"/>
                <img src="https://languedoc-roussillon-universites.fr/images/img/Actus-img/2019/actu-Region-Occitanie-thumb.jpg"alt="image article"/>
                </article>
        </section>         
        <footer>
            <nav>
