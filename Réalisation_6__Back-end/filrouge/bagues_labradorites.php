    ...
    <body>
        <header><!-- CSS en pleine page --></header>
            ...
            <section>
                <article>
                    <div>
                        <img src="https://www.omyoki.com/wp-content/uploads/2018/06/bague-labradorite-en-argent-3.jpg" alt="image article"/>
                    </div>
                </article>
                <div id="tableau">
                    <table>
                        <caption>Nos bagues en labradorite</caption>
                        <tr>
                            <th><a href="../filrouge/images/bague_labradorite1_grande.jpg"><img src="../Fil_rouge/Images/bague_labradorite1.gif"></a></th>
                            <th>Bague en labradorite. 1€</th>
                            <th><input class="button styled"
                                type="button"
                                value="Ajouter au panier"></th>
                        </tr>
                        <tr>
                            <th><a href="../filrouge/images/bague_labradorite2_grande.jpg"><img src="../Fil_rouge/Images/bague_labradorite2.gif"></a></th>
                            <th>Bague en labradorite. 1€</th>
                            <th><input class="button styled"
                                type="button"
                                value="Ajouter au panier"></th>
                        ...
                        <tr>
                            <th><a href="../filrouge/images/bague_labradorite3_grande.jpg"><img src="../Fil_rouge/Images/bague_labradorite3.gif"></a></th>
                            <th>Bague en labradorite. 1€</th>
                            <th><input class="button styled"
                                type="button"
                                value="Ajouter au panier"></th>
                        ...
                        <tr>
                            <th><a href="../filrouge/images/bague_labradorite4_grande.jpg"><img src="../Fil_rouge/Images/bague_labradorite4.gif"></a></th>
                            <th>Bague en labradorite. 1€</th>
                            <th><input class="button styled"
                                type="button"
                                value="Ajouter au panier"></th>
                        ...
                        <tr>
                            <th><a href="../filrouge/images/bague_labradorite_grande5.jpg"><img src="../Fil_rouge/Images/bague_labradorite5.gif"></a></th>
                            <th>Bague en labradorite. 1€</th>
                            <th><input class="button styled"
                                type="button"
                                value="Ajouter au panier"></th>
            ...
            <div id="galerie">
                    <h3>Nos produits</h3>
                    <div class="galerie">
                        <a href="../filrouge/labradorite.html"><img src="../filrouge/images/labradorite.gif"></a>
